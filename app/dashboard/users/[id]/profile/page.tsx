...
import { Loader2, ArrowLeft, Calendar, Clock, TrendingUp, Target, Activity, BarChart3, Dumbbell } from "lucide-react"
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      if (assignmentsError) {
        ...
        // Εύρεση τρέχοντος προγράμματος (το πιο πρόσφατο ενεργό)
      ...
      // TODO: Φόρτωση στατιστικών προπόνησης (placeholder data για τώρα)
      setTrainingStats({
        thisWeekHours: 4.5,
        thisMonthHours: 18.2,
        thisWeekVolume: 2.8, // τόνοι
        thisMonthVolume: 12.5,
        weeklyChange: 15, // ποσοστό αλλαγής
        monthlyChange: -8,
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <Button variant="ghost" size="sm" onClick={() => router.push("/dashboard/users")} className="mr-4">
            ...
            <CardContent>
              {currentProgram ? (
                ...
                <div className="text-center py-8">
                  ...
                  <Button className="mt-4">Ανάθεση Προγράμματος</Button>
                </div>
              )}
            </CardContent>
          </Card>
